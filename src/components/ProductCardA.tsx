...
const ProductCardA = ({ title, price, images }: ProductWithId) => {

    return (
        <div className="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#" className="flex justify-center h-40">
                <img className="p-8 rounded-t-lg max-w-xs" src={images[0]} alt="product image" />
            </a>

            <div className="px-5 pb-5 h-40 relative">
                <a href="#">
                ...
                <div className="flex items-center justify-between absolute bottom-5 right-5 left-5">
